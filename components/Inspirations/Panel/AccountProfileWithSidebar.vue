...
<div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
  <aside class="py-6 px-2 sm:px-6 lg:py-0 lg:px-0 lg:col-span-3">
    <nav class="space-y-1">
      <a href="#" class="group bg-gray-50 rounded-md px-3 py-2 flex items-center text-sm font-medium text-indigo-700 hover:text-indigo-700 hover:bg-white" aria-current="page">
        <!-- Heroicon name: user-circle -->
        <svg class="flex-shrink-0 -ml-1 mr-3 h-6 w-6 text-indigo-500 group-hover:text-indigo-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
      ...
      <a href="#" class="group rounded-md px-3 py-2 flex items-center text-sm font-medium text-gray-900 hover:text-gray-900 hover:bg-gray-50">
        <!-- Heroicon name: key -->
