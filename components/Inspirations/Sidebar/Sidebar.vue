      ...
      <div class="relative max-w-xs w-full bg-white pt-5 pb-4 flex-1 flex flex-col">
        ...
        <div class="mt-5 flex-1 h-0 overflow-y-auto">
          <nav class="px-2 space-y-1">
            <a href="#" class="group bg-gray-100 rounded-md py-2 px-2 flex items-center text-base font-medium text-gray-900">
              <!-- Heroicon name: home -->
              <svg class="mr-4 h-6 w-6 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
              Dashboard
            </a>

            <a href="#" class="group rounded-md py-2 px-2 flex items-center text-base font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50">
              <!-- Heroicon name: users -->
      ...
      <div class="border-r border-gray-200 pt-5 pb-4 flex flex-col flex-grow overflow-y-auto">
        ...
        <div class="flex-grow mt-5 flex flex-col">
          <nav class="flex-1 bg-white px-2 space-y-1">
            <a href="#" class="group bg-gray-100 rounded-md py-2 px-2 flex items-center text-sm font-medium text-gray-900 hover:text-gray-900 hover:bg-gray-100">
              <!-- Heroicon name: home -->
              <svg class="mr-3 h-6 w-6 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
              Dashboard
            </a>

            <a href="#" class="group rounded-md py-2 px-2 flex items-center text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50">
              <!-- Heroicon name: users -->
      ...
      <div class="flex-1 flex justify-between px-4 md:px-0">
        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <div class="ml-3 relative">
            <div>
              <button class="max-w-xs flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" id="user-menu" aria-haspopup="true">
