...
<nav class="border-t border-gray-200 px-4 flex items-center justify-between sm:px-0">
  ...
  <div class="hidden md:-mt-px md:flex">
    <a href="#" class="border-t-2 border-transparent pt-4 px-4 inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
      1
    </a>
    <a href="#" class="border-t-2 border-indigo-500 pt-4 px-4 inline-flex items-center text-sm font-medium text-indigo-600" aria-current="page">
      2
    </a>
    <a href="#" class="border-t-2 border-transparent pt-4 px-4 inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
      3
