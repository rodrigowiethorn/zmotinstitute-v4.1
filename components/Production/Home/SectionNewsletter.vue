  ...
  <div class="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
    <div class="px-6 py-6 bg-indigo-700 rounded-lg md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center">
      <div class="xl:w-0 xl:flex-1">
        <h2 class="text-2xl font-extrabold tracking-tight text-white sm:text-3xl text-center lg:text-left">
          Acompanhe o ZMOT INSTITUTE
        </h2>
        <p class="mt-3 max-w-3xl text-lg leading-6 text-indigo-200 text-center lg:text-left">
          Fique ligado em todas as novidades sobre o ZMOT, Comportamento do Consumidor e Marketing Digital. Increva-se na nossa newsletter mensal.
        </p>
      </div>
      <div class="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
        <form class="sm:flex">
          <label for="emailAddress" class="sr-only">Email</label>
          <input id="emailAddress" name="emailAddress" type="email" autocomplete="email" required class="w-full border-white px-5 py-3 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-700 focus:ring-white rounded-md" placeholder="Digite seu email">
